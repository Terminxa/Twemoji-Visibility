...
//               chat text        & input       emoji selector      shown chat        cp chat text       cp shown chat        & tooltips          & title            bossbar              tab           (idk what else)     (idk what else)
    } else if (depth == 50.0 || depth == 0.0 || depth == 350.0 || depth == 3250.0 || depth == 0.001 || depth == 3200.001 || depth == 400.0 || depth == 3000.0 || depth == 1000.0 || depth == 3400.0 || depth == 3000.004 || depth == 2800.0) { 
